...
export default function Content({ data, meta }) {
  ...
  const tableData = tableHeaderReplace(
    filteredData,
    ['employee_code', 'employee_name', 'employee_type', 'plant_code', 'Breakfast_Count','Breakfast_Amount','Lunch_Count','Lunch_Amount', 'Dinner_Count', 'Dinner_Amount', 'Tea_Count', 'Tea_Amount', 'Snacks_Count', 'Snacks_Amount', 'Casual_Meals_Count', 'Casual_Meals_Amount', 'Canteen_Total', 'GST','AC_Dine_Charge', 'Total'],
    tableHeader
  );
